...
(function ($) {
	...
	$.fn.tweetMachine = function (query, options, callback) {
		...
		$(this).each(function () {
			...
			if (this.tweetMachine) {
				...
				settings = $.extend({
					...
					limit:          3, // Number of tweets to display at a time
					...
					tweetFormat: 	"<li class='tweet'>"+
										"<a class='tweet_avatar'><img class='avatar' src=''/></a>"+
										//"<a href='' class='tweet_user username'></a>"+						//We've hidden twitter username to lower the SEO overload
										"<span class='tweet_text content'></span>"+
										"<span class='tweet_time' href='' ><a class='time' href=''></a></span>"+
									"</li>", // Format for each tweet
		...
		$("div.tweet").wrap('<ul class="tweet_list"></ul>');
	};
})(jQuery);
